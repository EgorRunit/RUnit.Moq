...
{
    public class CallbackFunctionsTest
    {
        [Fact]
        public void Return_CallbackResult()
        {
            //arrange
            var callbackFunctions = new CallbackFunctions<CallbackResult>();
            ...
            bAssert.IsType<CallbackResult>(callbackResult);
        }
        ...
        [Fact]
        public void Execute_ConstInt_Return_ReturnsThrow()
        {
            //arrange
            const int constValue1 = 2;
            const int constValue2 = 3;
        ...
        [Fact]
        public void Execute_VarInt_Return_ReturnsThrow()
        {
            //arrange
            var varValue1 = 2;
            var varValue2 = 3;
        ...
        [Fact]
        public void Execute_ConstString_Return_ReturnsThrow()
        {
            //arrange
            const string constValue1 = "222";
            const string constValue2 = "333";
        ...
        [Fact]
        public void Execute_VarString_Return_ReturnsThrow()
        {
            //arrange
            var varValue1 = "222";
            var varValue2 = "333";
        ...
        [Fact]
        public void Execute_VarStringBuilder_Return_ReturnsThrow()
        {
            //arrange
            var varValue1 = new StringBuilder("1111");
            var varValue2 = new StringBuilder("2222");
